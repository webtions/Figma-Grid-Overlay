...
Visually check if your layout matches your Figma design by overlaying a responsive grid on the frontend.
...
1. Upload the plugin folder to `/wp-content/plugins/figma-grid-overlay/`
2. Activate the plugin through the “Plugins” menu
3. Go to **Settings → Figma Grid Overlay** and configure your options
